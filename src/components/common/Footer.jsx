        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="mailto:projjwal.roy1@gmail.com?body=fell free to type">
                    Gmail
                  </a>
                </li>
                <li>
                  <a href="tel:7980341287">Helpline No</a>
                </li>
              </ul>
            </div>
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/projjwal-roy/"
                  target="blank"
                >
                  <FaLinkedin className=" mx-auto mt-3 scale-125" />
                </a>
                <a href="https://twitter.com/Projjwal23" target="blank">
                  <FaTwitter className=" mx-auto mt-3 scale-125" />
                </a>

                <a href="https://www.instagram.com/projjwal23/" target="blank">
